...
/* harmony import */ var _modules_range__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/range */ "./js/modules/range.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_range__WEBPACK_IMPORTED_MODULE_2__["stylizeRange"])();
  Object(_modules_range__WEBPACK_IMPORTED_MODULE_2__["hangEventHandlers"])();
...
/*!*****************************!*\
  !*** ./js/modules/range.js ***!
  \*****************************/
/*! exports provided: stylizeRange, hangEventHandlers */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "stylizeRange", function() { return stylizeRange; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hangEventHandlers", function() { return hangEventHandlers; });
var rangeInputs = document.querySelectorAll('input[type="range"]');
var numberInput = document.querySelector('input[type="number"]');
var buttonPrice = document.querySelector('.calculator__range-result-placeholder--price');
var buttonContribution = document.querySelector('.calculator__range-result-placeholder--contribution');
var buttonTerm = document.querySelector('.calculator__range-result-placeholder--term');
var inbutPrice = document.querySelector('.calculator__range-result-number--price');
var inbutContribution = document.querySelector('.calculator__range-result-number--contribution');
var inbutTerm = document.querySelector('.calculator__range-result-number--term');
var rangePrice = document.querySelector('.calculator__range--price');
var rangeContribution = document.querySelector('.calculator__range--contribution');
var rangeTerm = document.querySelector('.calculator__range--term');
var stylizeRange = function stylizeRange() {
...
var showInputPrice = function showInputPrice() {
...
var showInputContribution = function showInputContribution() {
...
var showInputTerm = function showInputTerm() {
...
var hangEventHandlers = function hangEventHandlers() {
  buttonPrice.addEventListener('click', function () {
    showInputPrice();
  });
  buttonTerm.addEventListener('click', function () {
    showInputTerm();
  });
  buttonContribution.addEventListener('click', function () {
    showInputContribution();
  });
  rangePrice.addEventListener('click', function () {
    showInputPrice();
  });
  rangeContribution.addEventListener('click', function () {
    showInputContribution();
  });
  rangeTerm.addEventListener('click', function () {
    showInputTerm();
  });
};
